...
struct FawStrings
{
    static let coffeeToGo = "\u{f6c5}"
    static let coffeeHot = "\u{f7b6}"
    static let cookie = "\u{f563}"
    static let checkDouble = "\u{f560}"
    static let fiveHundredPixels = "\u{f26e}"
    static let addressBook = "\u{f2b9}"
    static let addressBookO = "\u{f2ba}"
    static let addressCard = "\u{f2bb}"
    static let addressCardO = "\u{f2bc}"
    ...
    static let envelopeOpen = "\u{f2b6}"
    static let envelopeOpenO = "\u{f2b7}"
    static let envelopeSquare = "\u{f199}"
    static let envira = "\u{f299}"
    static let eraser = "\u{f12d}"
    static let etsy = "\u{f2d7}"
    ...
    static let freeCodeCamp = "\u{f2c5}"
    ...
    static let globe_europe = "\u{f7a2}"
    ...
    static let idBadge = "\u{f2c1}"
    static let idCard = "\u{f2c2}"
    static let idCardO = "\u{f2c3}"
    static let ils = "\u{f20b}"
    static let image = "\u{f03e}A"
    static let imdb = "\u{f2d8}"
    ...
    static let meetup = "\u{f2e0}"
    static let mehO = "\u{f11a}"
    static let mercury = "\u{f223}"
    static let microchip = "\u{f2db}"
    ...
    static let shower = "\u{f2cc}"
    static let signIn = "\u{f2f6}"
    ...
    static let thermometerEmpty = "\u{f2cb}"
    static let thermometerFull = "\u{f2c7}"
    static let thermometerHalf = "\u{f2c9}"
    static let thermometerQuarter = "\u{f2ca}"
    static let thermometerThreeQuarters = "\u{f2c8}"
    ...
    static let userO = "\u{f2c0}"
    static let userCircle = "\u{f2bd}"
    static let userCircleO = "\u{f2be}"
    ...
    static let windowClose = "\u{f2d3}"
    static let windowCloseO = "\u{f2d4}"
    static let windowMaximize = "\u{f2d0}"
    static let windowMinimize = "\u{f2d1}"
    static let windowRestore = "\u{f2d2}"
    static let windows = "\u{f17a}"
    static let won = "\u{f159}A"
    static let wordpress = "\u{f19a}"
    static let wpbeginner = "\u{f297}"
    static let wpexplorer = "\u{f2de}"
